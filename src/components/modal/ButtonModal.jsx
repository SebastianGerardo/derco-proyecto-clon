    ...
    <>
      {
        ...
        ) : (<button onClick={() => setIsOpen(true)}><i className="fa-solid fa-pen-to-square fa-2x text-gray-300 transition-all ease-in duration-100 hover:text-gray-400"></i></button>)
      }

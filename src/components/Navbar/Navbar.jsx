                ...
                <div className="relative flex h-16 items-center justify-between">
                    <div className="flex justify-between gap-4 ">
                        ...
                        <div className="ml-3 flex items-center md:!flex lg:!hidden xl:!hidden">
                            ...
                            <div ref={ref} className={`z-999 bg-redDerco h-screen shadow-lg absolute top-full translate-x-[-150%] transition ${menu && "translate-x-[-8%]"} w-64`}>
                                <BarraMenu />
                            </div>
                        </div>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="relative ml-3">
                            <div>
                                ...
                                <div className={`absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden ${menuUser && '!block'}`} >
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 transition-all duration-150 hover:text-gray-500"><i className="fa-solid fa-gear fx-1 mr-2"></i>Cambiar Contraseña</a>

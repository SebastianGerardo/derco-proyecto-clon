...
const columns = [
  {
    cell: () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="stroke-current text-gray-700/50 hover:text-sky-700 w-6 h-6">

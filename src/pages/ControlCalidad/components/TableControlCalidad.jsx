...
import { ModalControlCalidad } from "./ModalControlCalidad";

export const TableControlCalidad = ({ data }) => {
    ...
    },
    {
      ...
      cell: row =>
        <div className="flex items-center gap-3">
          <ModalControlCalidad tipo="timer" data={row} /> {/* ESTO SE IMPLEMENTARA LUEGO */}
